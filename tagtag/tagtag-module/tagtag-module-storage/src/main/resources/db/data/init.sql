...
INSERT INTO iam_menu (parent_id, menu_name, menu_code, path, component, icon, sort, status, menu_type, hide_in_menu, link, remark, keep_alive, create_time, create_by, update_by)
SELECT 
    (SELECT id FROM iam_menu WHERE menu_code='system'), 
    '文件管理', 'system:file', '/system/file', 'modules/storage/file/index', 'lucide:folder', 60, 1, 1, 0, NULL, '文件管理页面', 0, CURRENT_TIMESTAMP, 0, 0
